...
import './Edit.css'; // Import specific CSS for EditProfile component

const EditProfile = () => {
    return (
        <div className="edit-profile-container container-xl px-4 mt-4" style={{ justifyContent: 'center', alignItems: 'center' }}>
